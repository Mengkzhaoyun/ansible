...
REGISTRY_BUSYBOX_REPO="${REGISTRY_BUSYBOX_REPO:-}"
REGISTRY_BUSYBOX_VERSION="${REGISTRY_BUSYBOX_VERSION:-}"
...
if ! [[ -e /etc/kubernetes/data/registry/docker/registry/v2/repositories/k8s/$REGISTRY_BUSYBOX_REPO ]]; then
  docker pull $REGISTRY_REMOTE$REGISTRY_BUSYBOX_REPO$REGISTRY_REMOTE_SPLIT$REGISTRY_BUSYBOX_VERSION
  docker tag $REGISTRY_REMOTE$REGISTRY_BUSYBOX_REPO$REGISTRY_REMOTE_SPLIT$REGISTRY_BUSYBOX_VERSION $REGISTRY_LOCAL$REGISTRY_BUSYBOX_REPO$REGISTRY_LOCAL_SPLIT$REGISTRY_BUSYBOX_VERSION
  docker push $REGISTRY_LOCAL$REGISTRY_BUSYBOX_REPO$REGISTRY_LOCAL_SPLIT$REGISTRY_BUSYBOX_VERSION 
fi
